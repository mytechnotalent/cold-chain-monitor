...
def _verify_full_coverage(report: str) -> bool:
    ...
    for line in report.splitlines():
        if any(src in line for src in ("crc.c", "sensor.c", "display.c",
                                       "radio.c", "status_led.c", "button.c",
                                       "servo.c", "ir_remote.c", "chacha20.c",
                                       "poly1305.c", "crypto_aead.c",
                                       "blake2b.c", "argon2.c", "crypto_kdf.c",
